export const allCardsEvo = [
  ...
  "Zerael, Regent of Vicissitude",
  "Smeltwork Bodyguard Evolved",
  "Rolo Roné, Verdant Purifier Evolved",
  "Verdant Authority Caretaker Evolved",
  "Verdant City Pugilist Evolved",
  "Blossoming Lunerian Evolved",
  "Verdant Law Supplicant Evolved",
  "Shinra, All Discerning Evolved",
  "Bird's-Eye Investigator Evolved",
  "Cold Case Analyst Evolved",
  "Blind Spot Surveyor Evolved",
  "Monika, Cloudhall Admiral Evolved",
  "Mana, Sterling Luster Evolved",
  "Bejeweled Supermodel Evolved",
  "Bejeweled Advisor Evolved",
  "Bejeweled Bouncer Evolved",
  "Carbuncle of Mysteria Evolved",
  "El, Destructive Dragon Evolved",
  "Dragon-Eyed Secretary Evolved",
  "Neon-Tailed Prefect Evolved",
  "Ian, Dragon Buster Evolved",
  "Lightning-Clawed Loafer Evolved",
  "Ilze & Urze, Centennial Reapers Evolved",
  "Vania, Crimson Majesty Evolved",
  "Covetous Serpent Evolved",
  "Exhumation Crow Evolved",
  "Gnawing Rat Evolved",
  "Beryl, Dreameater Evolved",
  "Seishiro, Admonishing Faith Evolved",
  "Conferrer of Vows Evolved",
  "Deliverer of Punishment Evolved",
  "Lorena, Iron-Willed Priest Evolved",
  "Votary of Contemplation Evolved",
  "Saito, Mao Ward Officer Evolved",
  "Stunfist Assassin Evolved",
  "Cyberglasses Criminal Evolved",
